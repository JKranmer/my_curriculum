...
(function ($) {
	var pushy = $('.pushy'), //menu css class
		body = $('body'), // preciso mudar essa variavel dinamicamente por botao ... para ter varios menus
	...
	function togglePushy() {
		...
		if (pushy.hasClass(pushyOpenLeft) || pushy.hasClass(pushyOpenRight)) {
	...
	if(cssTransforms3d){
		...
		menuBtn.on('click', function(event) {
			body = $(event.target.dataset.menu)
